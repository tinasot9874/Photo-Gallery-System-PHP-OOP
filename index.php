				...
				<div class="photograhy">
					<div class="row no-gutters">
						...
						<div class="col-md-4 ftco-animate">
							<a href="<?php echo "admin".DS.$value->picture_path(); ?>" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(admin/images/thumbnail/<?php echo $value->filename; ?>); object-fit: fill;">
