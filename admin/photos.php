                            ...
                            <div style="width: 100%; height:350px; overflow:auto;">
                                <table class="table table-hover table-bordered">
                                    ...
                                    foreach ($photo as $value):
                                        ?>
                                        <tr>
                                            <td><img style="width:200px;height: 100px;object-fit: contain; "
                                                     src="<?php echo $value->picture_resize_path(); ?>" alt=""></td>
                                            <td><?php $user = User::find_by_id($value->user_id);
                                                echo $user->username; ?></td>
                                            <td><?php echo $value->title; ?></td>
                                            <td><?php $category = Category::find_by_id($value->categories_id);
                                                echo $category->category_name; ?></td>
                                            <td><?php echo $value->type; ?></td>
                                            <td><?php echo round($value->size / 1000000, 2); ?> Mb</td>
                                            <td><?php echo $value->create_at; ?></td>
                                            <td>
                                                <a href="edit.php?edit_photo=<?php echo $value->id; ?>"
                                                   style="cursor: pointer;" class="edit" title="Edit"
                                                   data-toggle="tooltip"><i class="fas fa-edit"></i></a>
                                                <a href="delete.php?photo=<?php echo $value->id; ?>"
                                                   style="cursor: pointer;" class="delete" title="Delete"
